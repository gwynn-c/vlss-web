...
<div class="base-100 shadow-sm ">

    <h2 class="card-title">Privacy Policy</h2>
    <p>
        Very Longsword builds mobile games as Ad Supported games. 
        This SERVICE is provided by Very Longsword at no cost and is intended for use as is.
    ...
    Link to privacy policy of third party service providers used by the games:
    </p>
    <ul class="list-row"><a href="https://www.google.com/policies/privacy/" class="link">Google Play Services</a></ul>
    <ul class="list-row"><a href="https://support.google.com/admob/answer/6128543?hl=en" class="link">AdMob</a></ul>
    ...
    <h2><b>Log Data</b></h2>
        <p>
        We want to inform you that whenever you use our Service, in a case of an error in the games we collect data and information (through third party products) on your phone called Log Data. 
        This Log Data may include information such as your device Internet Protocol (“IP”) address, device name, operating system version, the configuration of the game when utilizing our Service, 
    ...
    <div class="divider"></div>    
     ...
     <h2><b>Cookies</b></h2>
         <p>Cookies are files with a small amount of data that are commonly used as anonymous unique identifiers. 
            ...
            This Service does not use these “cookies” explicitly. However, the s may use third party code and libraries that use “cookies” to collect information and improve their services.
    ...
    <p>
        ...
        <ul>To perform Service-related services;</ul>
...
<h2><b>Contact Us</b></h2>
         <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at <a href="mailto:dev.vlss@proton.me" class="link">dev.vlss@proton.me.</a></p>
